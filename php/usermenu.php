...
<?php
  ...
  if($_SESSION['userinfo']->email_active){
    echo '<li><div class="icon-square d-inline-flex align-items-center justify-content-center fs-8 flex-shrink-0 me-3">
    <img class="p-1" src="/media/img/serviceicons/mastodon_icon1.png">
...
<?php
  ...
  if($_SESSION['userinfo']->email_active){
    echo '<li><div class="icon-square d-inline-flex align-items-center justify-content-center fs-8 flex-shrink-0 me-3">
    <img class="p-1" src="/media/img/serviceicons/element_icon1.png">
...
<?php
  ...
  if($_SESSION['userinfo']->email_active){
    echo '<li><div class="icon-square d-inline-flex align-items-center justify-content-center fs-8 flex-shrink-0 me-3">
    <img class="p-1" src="/media/img/serviceicons/discourse_icon1.png">
